...
#    Updated: 2020/09/08 15:06:33 by anonymous     ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
SRC =  main.c utils_nflag.c check_args.c itoa_base.c reading.c intro.c str_rev_by_2.c\
		...
		live.c visualizer.c ld.c st.c add.c sub.c and.c or.c xor.c write.c ldi.c
...
OBJ =  main.o utils_nflag.o check_args.o itoa_base.o reading.o intro.o str_rev_by_2.o\
		...
		live.o visualizer.o ld.o st.o add.o sub.o and.o or.o xor.o write.o ldi.o
